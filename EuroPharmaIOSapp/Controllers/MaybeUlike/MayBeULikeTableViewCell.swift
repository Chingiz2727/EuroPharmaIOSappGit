...
class MayBeULikeTableViewCell: UITableViewCell {
    let columnLayout = ColumnFlowLayout(cellsPerRow: 1, cellheight: 270, cellwidth: 200, minimumInteritemSpacing: 20, minimumLineSpacing: 20, sectionInset: UIEdgeInsets(top: 0, left: 5, bottom: 0, right: 5))
